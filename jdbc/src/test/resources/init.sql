...
----------------------------------
DROP TABLE IF EXISTS PERMISSION_USER_TABLE;
CREATE TABLE PERMISSION_USER_TABLE(ID INT PRIMARY KEY, NAME VARCHAR(255) DEFAULT '', USER_ID INT);

-- RECORDS
INSERT INTO PERMISSION_USER_TABLE VALUES(1, 'Ada', 1);
INSERT INTO PERMISSION_USER_TABLE VALUES(2, 'Kate', 2);
